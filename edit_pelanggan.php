...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_sql = "UPDATE pelanggan SET nama = ?, alamat = ?, email = ?, no_tlpn = ? WHERE id_pelanggan = ?";
    $stmt = $conn->prepare($update_sql);
    $stmt->bind_param("ssssi", $nama, $alamat, $email, $no_tlpn, $id_pelanggan);

    if ($stmt->execute()) {
        echo '<script>alert("Berhasil Mengubah Data Pelanggan");</script>';
                echo '<script>location="tables/pelanggan.php"</script>';
    } else {
        echo '<script>alert("Gagal Mengubah Data Pelanggan");</script>';
                echo '<script>location="edit_pelanggan.php"</script>';
    }
}
?>
          ...
          <div class="page-inner">
            <div class="page-header">
              ...
              <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                  <a href="tables/pelanggan.php">Pelanggan</a>
                </li>
                <li class="separator">
                  <i class="icon-arrow-right"></i>
                <li class="nav-item">
