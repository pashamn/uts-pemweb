...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Update data produk
    $update_sql = "UPDATE produk SET nama = ?, harga = ?, ukuran = ?, warna = ?, id_supplier = ? WHERE id_produk = ?";
    $stmt = $conn->prepare($update_sql);
    $stmt->bind_param("ssssii", $nama, $harga, $ukuran, $warna, $id_supplier, $id_produk);

    if ($stmt->execute()) {
        echo '<script>alert("Berhasil Mengubah Data Produk");</script>';
        echo '<script>location="tables/produk.php"</script>';
    } else {
        echo '<script>alert("Gagal Mengubah Data Produk");</script>';
        echo '<script>location="edit_produk.php?id_produk=' . $id_produk . '"</script>';
    }
}
?>
            ...
            <div class="card">
              ...
              <form method="post" class="shadow p-4 rounded">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label for="defaultSelect">Pilih Supplier</label>
                    <select class="form-select form-control" id="id_supplier" name="id_supplier" value="<?php echo $data['id_supplier']; ?>" required>
                      <!-- <option value="<?php echo $data['id_supplier']; ?>">Pilih Supplier</option> -->
                      <?php
