              ...
              <div class="card-body">
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    // Query untuk menghitung total quantity berdasarkan tiap order
                    $sql = "SELECT `order`.*, pelanggan.nama, SUM(detail_order.jumlah) AS total_quantity 
                            FROM `order`
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>" . $row["total_quantity"] . "</td>"; // Menampilkan total quantity
                            echo "<td>";
                            echo "<a href='../detail.php?id=" . $row["id_order"] . "' class='btn btn-info'>detail</a> ";
                            echo "</td>";
                            echo "</tr>";
                        }
                    } else {
