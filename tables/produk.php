                ...
                <table class="table table-hover">
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Supplier</th> <!-- Kolom baru -->
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT produk.*, supplier.nama_supplier FROM produk 
                    ...
                    if ($result->num_rows > 0) {
                      ...
                      while($row = $result->fetch_assoc()) {
                          ...
                          echo "<td>";
                          echo "<a href='../edit_produk.php?id_produk=" . $row["id_produk"] . "' class='fa fa-edit me-3'></a> ";
                          echo "<a href='../hapus_produk.php?id_produk=" . $row["id_produk"] . "' class='fa fa-times text-danger' onclick='return confirm(\"Yakin ingin menghapus produk ini?\")'></a>";
                          echo "</td>";
                          echo "</tr>";
                      }
                    } else {
