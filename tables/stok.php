      ...
      <div class="main-panel">
        ...
        <div class="container">
          ...
          <div class="page-header">
            ...
            <!-- Tombol Tambah Data -->
            <div class="mb-3">
              <a href="../tambah_stok.php" class="btn btn-primary">Tambah</a>
            </div>
              ...
              <div class="card-body">
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT stok.*, produk.nama FROM stok 
                    ...
                    if ($result->num_rows > 0) {
                      ...
                      while($row = $result->fetch_assoc()) {
                          ...
                          echo "<td>" . $no++ . "</td>";
                          echo "<td>" . $row["nama"] . "</td>";
                          echo "<td>" . $row["jmlh_stok"] . "</td>";
                          echo "<td>" . $row["tgl_update"] . "</td>";
                          echo "<td>";
                          echo "<a href='../edit_stok.php?id_stok=" . $row["id_stok"] . "' class='fa fa-edit me-3'></a> ";
                          echo "<a href='../hapus_stok.php?id_stok=" . $row["id_stok"] . "' class='fa fa-times text-danger' onclick='return confirm(\"Yakin ingin menghapus pelanggan ini?\")'></a>";
                          echo "</td>";
                          echo "</tr>";
                      }
                    } else {
