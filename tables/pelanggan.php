      ...
      <div class="main-panel">
        ...
        <div class="container">
          <div class="page-inner">
            ...
            <!-- Tombol Tambah Data -->
            <div class="mb-3">
              <a href="../tambahpelanggan.php" class="btn btn-primary">Tambah</a>
            </div>
                  ...
                  <tbody>
                    ...
                    if ($result->num_rows > 0) {
                      ...
                      while($row = $result->fetch_assoc()) {
                          ...
                          echo "<td>";
                          echo "<a href='../edit_pelanggan.php?id_pelanggan=" . $row["id_pelanggan"] . "' class='fa fa-edit me-3'></a> ";
                          echo "<a href='../hapus_pelanggan.php?id_pelanggan=" . $row["id_pelanggan"] . "' class='fa fa-times text-danger' onclick='return confirm(\"Yakin ingin menghapus pelanggan ini?\")'></a>";
                          echo "</td>";
                          echo "</tr>";
                      }
                    } else {
